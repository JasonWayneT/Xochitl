...
| `FR-SEC-005` | `CR-016` | `CR-016` | `AC-CR016-001`, `AC-CR016-002`, `AC-CR016-003`, `AC-CR016-004`, `AC-CR016-005`, `AC-CR016-006`, `AC-CR016-007` | `TASK-SEC-016` | `src/security.py` (`validate_outbound_url`, `_BLOCKED_NETWORKS`, `_ALLOWED_SCHEMES`), `src/skills/web_lookup_skill.py` (`_search`, `_fetch_text`), `src/skills/weather_skill.py` (`_fetch_json`) | smoke (AC-CR016-001–005) + code inspection (AC-CR016-006–007) | implemented |
