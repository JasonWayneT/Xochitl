...
| `FR-INIT-001` | `CR-036` | `CR-036` | `AC-CR036-001`, `AC-CR036-002`, `AC-CR036-003`, `AC-CR036-004` | `TASK-INIT-036-a` | `src/initiative.py` (`InitiativeEngine.submit()`, `_CONFIDENCE_THRESHOLD=0.80`, mode gate, suppression gate) | smoke (AC-CR036-001–004) | implemented |
| `FR-INIT-002` | `CR-036` | `CR-036` | `AC-CR036-005` | `TASK-INIT-036-a` | `src/initiative.py` (`dismiss()`, `_DISMISS_THRESHOLD=3`, `_suppressed` set) | smoke (AC-CR036-005) | implemented |
| `FR-INIT-003` | `CR-036` | `CR-036` | `AC-CR036-002` | `TASK-INIT-036-a` | `src/initiative.py` (`drain()` returns and clears `_pending`) | smoke (AC-CR036-002) | implemented |
| `NFR-INIT-001` | `CR-036` | `CR-036` | `AC-CR036-001` through `AC-CR036-005` | `TASK-INIT-036-b` | `src/initiative.py` (try/except in all public methods); `src/chat.py` (drain+inject in `_agent_loop()`, `/dismiss` slash command); `src/background_review.py` (`submit_initiative()`, `_initiative_engine` field) | smoke + source inspection | implemented |
