...
class ContextManager:
    ...
    def assemble_system_prompt(self, mode: str = "conversational") -> str:
        ...
        base_guard = (
            ...
            "6. NEVER refer to yourself in the third person. Always use first-person ('I', 'me', 'my').\n"
            "7. When the user asks about PC specs, hardware details, system info, or what hardware/software "
            "is running — ALWAYS use ShellSkill with command 'systeminfo'. Do NOT ask which command to run. "
            "Do NOT explain how to check manually. Just invoke ShellSkill.\n"
            "8. When you try something and it doesn't contain what the user needs (e.g. systeminfo "
            "has no PSU model), say: what you ran, what was missing, WHY it's missing, and the best "
            "path forward. Never leave the user stuck — always bridge the gap.\n\n"
            "## Language\n"
